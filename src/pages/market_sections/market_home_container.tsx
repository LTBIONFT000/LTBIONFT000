    ...
    <>
      {hasSeenBanner === undefined && (context.relay || context.networkId === networkIds.MAINNET) && (
        <Banner>
          ...
          <TextWrapper>
            <TextTitle>Scaling Demiurge with xDai Chain!</TextTitle>
            <TextDescription>
              You now have access to Demiurge markets on xDai Chain with your Mainnet Ethereum wallet. To use Omen on
