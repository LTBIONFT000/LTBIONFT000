import { MRNAXLogo } from '../components/common/logos/omen'
...
//OMEN: export const INFURA_PROJECT_ID = '9c6788bb15234036991db4637638429f'
export const INFURA_PROJECT_ID = 'ae1b741fe1b64ec3907cae28bbb240d8'
...
//DT:export const GRAPH_RINKEBY_HTTP = 'https://api.thegraph.com/subgraphs/name/protofire/omen-rinkeby'
//DT:export const GRAPH_RINKEBY_WS = 'wss://api.thegraph.com/subgraphs/name/protofire/omen-rinkeby'
export const GRAPH_RINKEBY_HTTP = 'https://api.thegraph.com/subgraphs/name/ltbionft000/dtg-g'
export const GRAPH_RINKEBY_WS = 'wss://api.thegraph.com/subgraphs/name/ltbionft000/dtg-g'
...
export const Logo = MRNAXLogo

export const DEFAULT_ARBITRATOR: KnownArbitrator = 'dt'

export const DEFAULT_TOKEN = 'dai'

export const DOCUMENT_TITLE = 'Clinical Trial Prediction Markets'
export const DOCUMENT_DESCRIPTION = 'Demiurge Information Markets'

export const DOCUMENT_VALIDITY_RULES = './rules.pdf'
export const DOCUMENT_FAQ = './faq.pdf'

export const OG_TITLE = 'Demiurge Prediction Markets'
export const OG_DESCRIPTION = 'Demiurge Information Markets'
export const OG_IMAGE = 'omen_logo_thumbnail.png'
export const OG_URL = 'https://www.demiurge.technology/'
export const OG_SITE_NAME = 'Demiurge'

export const TWITTER_CARD = 'summary_large_image'
export const TWITTER_IMAGE_ALT = 'Demiurge'
export const TWITTER_SITE = '@DemiurgeTech'
...
//Demiurge
export const DEFAULT_LIQUIDITY_PROTECTION_SUPPLYTO_ADDRESS_RINKEBY = '0x54C5De28B7e3A82d39061B8d75b573830f6bACE7'
export const DEFAULT_LIQUIDITY_PROTECTION_DEMANDFROM_ADDRESS_RINKEBY = '0x22c03a7240a65405F9844B3da3dA7304a9B61A2D'
export const DEFAULT_SERVICE_FEE_SUPPLYTO_ADDRESS_RINKEBY = '0xc0d74BeAD0bA069Ed55024199a1B0BDb8160E211'
export const DEFAULT_AUTHORIZED_MARKET_HOST_RINKEBY = '0xDCC1E35715405b6e4E6B6AC0aD8894ed798B8B49'
export const SERVICE_FEE_CUT = 2
