...
import { DOCUMENT_FAQ, DOCUMENT_VALIDITY_RULES, SERVICE_FEE_CUT } from '../../../common/constants'
    ...
    <>
        ...
        <div>
          <TransactionDetailsCard>
            ...
            <TransactionDetailsRow
              title={'Total Fee'}
              tooltip={`A ${feePercentage}% trading fee goes to liquidity providers.\nA ${SERVICE_FEE_CUT}% service fee goes to the platform.`}
              value={feeFormatted}
            />
      ...
      <WarningMessageStyled
        ...
        description=" This market predicts whether a clinical trial will meet its predefined primary endpoints that are duly disclosed to the public in that trial's registration on https://www.clinicaltrials.gov/.  
          This market will resolve to 'Success' if at least one primary endpoint is met according to topline analyses. 
      ...
      <StyledButtonContainer borderTop={true} marginTop={showSetAllowance || showUpgrade || isNegativeAmount}>
        ...
        <Button buttonType={ButtonType.buySecondaryLine} disabled={isBuyDisabled} onClick={() => finish()}>
          Buy
        </Button>
