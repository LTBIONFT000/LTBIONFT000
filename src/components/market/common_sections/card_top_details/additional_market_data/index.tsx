...
const AdditionalMarketDataSectionTitle = styled.p<{ isError?: boolean }>`
  ...
  line-height: 16px;
  white-space: nowrap;
  color: ${({ isError, theme }) => (isError ? theme.colors.clickable : theme.colors.clickable)};
  &:first-letter {
...
const AdditionalMarketDataSectionWrapper = styled.a<{
  ...
  &:hover {
    p {
      color: ${props => (props.isError ? props.theme.colors.primaryLight : props.theme.colors.primaryLight)};
    }
    svg {
      circle {
          ...
          <AdditionalMarketDataSectionWrapper
            ...
            data-tip={
              curatedByDxDaoOrKleros
                ...
                : 'This market is valid.'
            }
            hasMarginRight={true}
            isError={!curatedByDxDaoOrKleros}
          >
            {curatedByDxDaoOrKleros ? <IconAlert size={'24'} /> : <IconVerified size={'24'} />}
            <AdditionalMarketDataSectionTitle isError={!curatedByDxDaoOrKleros}>
              {curatedByDxDaoOrKleros ? 'Not Verified' : 'Verified'}
