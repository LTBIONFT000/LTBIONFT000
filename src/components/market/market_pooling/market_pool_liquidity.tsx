...
import { DOCUMENT_FAQ, SERVICE_FEE_CUT } from '../../../common/constants'
  ...
  return (
    <>
      ...
      <WarningMessageStyled
        ...
        description="Providing liquidity is riskless and lossless IF AND ONLY IF (1) you withdraw NO liquidity when the market is OPEN and (2) you withdraw ALL liquidity FIRST when the market is CLOSED."
        href={DOCUMENT_FAQ}
      ...
      <BottomButtonWrapper borderTop>
        ...
        {activeTab === Tabs.deposit && (
          <Button buttonType={ButtonType.buySecondaryLine} disabled={disableDepositButton} onClick={() => addFunding()}>
            Deposit
          </Button>
        )}
        {activeTab === Tabs.withdraw && (
