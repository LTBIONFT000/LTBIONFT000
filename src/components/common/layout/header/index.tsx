...
import { Network } from '../..'
import { DEFAULT_AUTHORIZED_MARKET_HOST_RINKEBY, Logo, STANDARD_DECIMALS } from '../../../../common/constants'
...
import { IconAdd, IconClose, IconMRNAX } from '../../icons'
...
export const LogoWrapper = styled.a<{ disabled?: boolean }>`
  ...
  border: 1px solid ${props => props.theme.colors.mainBodyBackground};
...
`
const MRNAXIconWrapper = styled.div`
  margin-left: 12px;
`
...
const HeaderContainer: React.FC = (props: any) => {
  ...
  //DEMIURGE: only demiurge authorized wallets can create markets
  const isCreateMarketbuttonDisabled = account !== DEFAULT_AUTHORIZED_MARKET_HOST_RINKEBY
      ...
      <HeaderInner>
        ...
        <ContentsRight>
          {isMarketCreatePage ? (
            ...
            <>
              {!isCreateMarketbuttonDisabled && (
                <div>
                  <ButtonCreateDesktop
                    {...createButtonProps}
                    //hidden={isCreateMarketbuttonDisabled}
                  >
                    Create Market
                  </ButtonCreateDesktop>
